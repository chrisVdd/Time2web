...
namespace Site\SeoBundle\Controller\admin;
...
class SeoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('SiteSeoBundle:admin/Seo:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_seo_show', array('id' => $entity->getId())));
        }

        return $this->render('SiteSeoBundle:admin/Seo:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Seo $entity)
    {
        $form = $this->createForm(new SeoType(), $entity, array(
            'action' => $this->generateUrl('admin_seo_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        return $this->render('SiteSeoBundle:admin/Seo:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SiteSeoBundle:admin/Seo:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new SeoType(), $entity, array(
            'action' => $this->generateUrl('admin_seo_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_seo_edit', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_seo_delete', array('id' => $id)))
            ->setMethod('DELETE')
